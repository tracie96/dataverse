...
const SectionContent = ({ headerInfo }: { headerInfo: HeaderInfo }) => {
  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="mx-auto mb-4 text-3xl font-bold text-black dark:text-white md:w-4/5 xl:w-1/2 xl:text-sectiontitle1">
          {subtitle}
        </h2>
