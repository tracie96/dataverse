  ...
  useEffect(() => {
    const handlePaymentSuccess = async () => {
      try {
        ...
        const applicationData = localStorage.getItem('cohort3_application_data');
        ...
        localStorage.removeItem('cohort3_application_data');
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            {paymentMethod === 'stripe' 
              ? 'Congratulations! Your payment has been processed successfully and your application for Cohort 3 has been submitted.'
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="text-center">
              ...
              <p className="text-sm text-green-700 dark:text-green-300">
                {paymentMethod === 'stripe' 
                  ? 'Your $25 payment has been processed'
                  : 'Your ₦37,500 transfer details received'
                }
              </p>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  If accepted, you'll choose your specialization track during orientation week.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Cohort 3 begins on Friday, September 26, 2025. You'll receive detailed program information via email.
                </p>
              </div>
            </div>
          </div>
